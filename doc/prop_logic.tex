 ...
 \begin{proof} \mbox{}
  \begin{enumerate}
   ...
   \item \mbox{}
		 ...
		 \end{prooftree}
   \item \mbox{}
		 (MP)と演繹定理より,$\phi,\phi \to \psi \vdash \psi$ならば$\vdash \phi \to ((\phi \to \psi) \to \psi)$.
		 \begin{prooftree}
		  \alwaysNoLine
		  \AxiomC{$\phi \to ((\phi \to \psi) \to \psi)$}
		  \AxiomC{[Lemma \ref{rule1}.5]}
		  \UnaryInfC{$((\phi \to \psi) \to \psi) \to (\lnot (\phi \to \psi) \to \lnot \phi)$}
		  \alwaysSingleLine
		  \RightLabel{(Lemma \ref{rule0}.1)}
		  \BinaryInfC{$\phi \to (\lnot (\phi \to \psi) \to \lnot \phi)$}
		 \end{prooftree}
   \item \mbox{}
		 演繹定理より,$\phi \to \psi,\lnot \phi \to \psi \vdash \psi$ならば
		 $\vdash (\phi \to \psi) \to ((\lnot \phi \to \psi) \to \psi)$.より,
		 $\phi \to \psi,\lnot \phi \to \psi \vdash \psi$を証明する.
		 \begin{prooftree}
		  \alwaysNoLine
		  \AxiomC{$\lnot \phi \to \psi$}
		  \AxiomC{[Lemma \ref{rule1}.5]}
		  \UnaryInfC{$(\lnot \phi \to \psi) \to (\lnot \psi \to \lnot \lnot \phi)$}
		  \alwaysSingleLine
		  \LeftLabel{(1)}
		  \RightLabel{(MP)}
		  \BinaryInfC{$\lnot \psi \to \lnot \lnot \phi$}
		 \end{prooftree}
		 \begin{prooftree}
		  \alwaysNoLine
		  \AxiomC{(1)}
		  \UnaryInfC{$\lnot \psi \to \lnot \lnot \phi$}
		  \AxiomC{[HA3]}
		  \UnaryInfC{$(\lnot \psi \to \lnot \lnot \phi) \to ((\lnot \psi \to \lnot \phi) \to \psi)$}
		  \alwaysSingleLine
		  \LeftLabel{(2)}
		  \RightLabel{(MP)}
		  \BinaryInfC{$(\lnot \psi \to \lnot \phi) \to \psi$}
		 \end{prooftree}
		 \begin{prooftree}
		  \alwaysNoLine
		  \AxiomC{$\phi \to \psi$}
		  \AxiomC{[Lemma \ref{rule1}.5]}
		  \UnaryInfC{$(\phi \to \psi) \to (\lnot \psi \to \lnot \phi)$}
		  \alwaysSingleLine
		  \RightLabel{(MP)}
		  \BinaryInfC{$\lnot \psi \to \lnot \phi$}
		  \alwaysNoLine
		  \AxiomC{(2)}
		  \UnaryInfC{$(\lnot \psi \to \lnot \phi) \to \psi$}
		  \alwaysSingleLine
		  \RightLabel{(MP)}
		  \BinaryInfC{$\psi$}
		 \end{prooftree}
...
\subsubsection{矛盾,無矛盾}
\begin{dfn}
とある形式化体系$S$においてある論理式$\phi$が存在し,$\phi$とその否定$\lnot \phi$がともに$S$にて証明可能なとき,
$S$は\textgt{矛盾}(inconsistent)するという. $S$が矛盾しないとき$S$は\textgt{無矛盾}(consistent)という.
\end{dfn}
\begin{thm}
